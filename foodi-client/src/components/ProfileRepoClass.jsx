...
const ProfileRepo = ({ userInfo, repoInfo }) => {
  ...
  const repoUrl = "https://github.com/Shashwat8038/JalPaan";
            ...
            >
              <h1
                className={`flex items-center justify-center rounded-md shadow-md my-5 p-4 ${
                  isDarkMode ? "bg-gray-700 text-orange-500" : "bg-gray-100 text-orange-600"
              ...
              >
                <Link
                  ...
                  className={`hover:scale-105 text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold ${
                    isDarkMode ? "hover:text-orange-400" : "hover:text-orange-500"
                  }`}
                >
                  {repo.name}
                </Link>
              ...
              <div className={`flex flex-col sm:flex-row items-center justify-between my-5 ${isDarkMode ? "text-orange-500" : "text-orange-600"}`}>
