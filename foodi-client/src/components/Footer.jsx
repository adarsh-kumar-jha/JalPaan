...
export const Footer = () => {
  ...
  return (
    <>
      <footer 
        className={`footer xl:px-24 py-10 px-4 text-base-content flex flex-col md:flex-row items-start md:items-center justify-between ${isDarkMode ? 'bg-black text-gray-300' : 'bg-white text-gray-800'}`}
      >
           <aside>
          ...
          <p className="font-patrick text-lg md:text-base ">Pure Swadeshi & Reliable since 2023</p>
        </aside>
      ...
      <footer 
        className={`footer items-center xl:px-24 py-10 px-4 flex flex-col md:flex-row justify-between ${isDarkMode ? 'bg-black text-gray-300' : 'bg-white text-gray-800'}`}
      >
            ...
            <span className='flex flex-col lg:flex-row lg:items-center'>
              <span className='flex flex-col lg:flex-row lg:items-center'>
                ...
                <span className="mt-2 lg:mt-0 lg:ml-3 flex items-center gap-2 inline">
                  <Link aria-label="LinkedIn" to="https://www.linkedin.com/in/adarsh-kumar-jha-306b81245?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer">
                    <FaLinkedin className="text-xl md:text-2xl" />
                  </Link>
                  <Link aria-label="GitHub" to="https://github.com/adarsh-kumar-jha" target="_blank" rel="noopener noreferrer">
                    <FaGithub className="text-xl md:text-2xl" />
                  </Link>
                  <Link aria-label="Instagram" to="https://www.instagram.com/adarsh_addi?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer">
              ...
              <span className='mt-4 lg:mt-0 flex flex-col lg:flex-row lg:items-center ml-3'>
                ...
                <span className="mt-2 lg:mt-0 lg:ml-3 flex items-center gap-2 inline">
                  <Link aria-label="LinkedIn" to="https://www.linkedin.com/in/shashwat-tiwari-06313924a/" target="_blank" rel="noopener noreferrer">
                    <CiLinkedin className="text-2xl md:text-3xl" />
                  </Link>
                  <Link aria-label="GitHub" to="https://github.com/Shashwat8038" target="_blank" rel="noopener noreferrer">
                    <FaSquareGithub className="text-xl md:text-2xl" />
                  </Link>
                  <Link aria-label="Instagram" to="https://www.instagram.com/shash1059/" target="_blank" rel="noopener noreferrer">
