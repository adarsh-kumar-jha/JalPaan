...
import { useTheme } from "../hooks/ThemeContext"; // Adjust the import path if needed

const SocialProfile1 = () => {
  const { isDarkMode } = useTheme();

  return (
    <div className={`flex justify-center items-center space-x-4 mt-8 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>
      <Link
      ...
      {/* Uncomment and adjust if Twitter link is available */}
      {/* <Link
