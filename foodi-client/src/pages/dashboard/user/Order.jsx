...
const Order = () => {
  ...
  <Link
    to="/"
    className={`inline-block -mt-1 px-4 py-2 text-lg font-medium text-black bg-green-600 hover:bg-green-700 rounded-lg transition-colors duration-300 ease-in-out ${isDarkMode ? "bg-green text-white" : "text-black"}`}
  >
    Back to Home
  </Link>
  <Link
    to="/dashboard"
    className={`inline-block -mt-1 px-4 py-2 ml-4 text-lg font-medium text-black bg-green-600 hover:bg-green-700 rounded-lg transition-colors duration-300 ease-in-out ${isDarkMode ? "bg-green text-white" : "text-black"}`}
  >
    Back to Dashboard
  </Link>
</button>
